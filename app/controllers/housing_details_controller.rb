class HousingDetailsController < ApplicationController
  ...
  def create
    ...
    # params[:housing_detail].delete :editor
  ...
  private
    ...
    def housing_detail_params
      params.require(:housing_detail).permit(:category_no, :category_name, :dorm, :size, :air_con, :balcony, :bathroom, :kitchen, :furniture, :cleaning, :description, :rent, :housing_detail_managements_id)
    end
end
